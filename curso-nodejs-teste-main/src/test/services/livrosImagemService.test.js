...
describe('Testandao livrosImagensServices.cadastrarImagens', () => {
    it('O sistema deve salvar uma imagem vinculado ao livro caso todos os dados estejam corretos', async () => {
        const imagemMock = {
            file: {
